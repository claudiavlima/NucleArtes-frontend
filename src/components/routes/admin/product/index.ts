...
import { getProductByArtesanoId, postProduct, updateProduct } from '../../../../redux/actions/productActions';
...
interface DispatchProps {
  ...
  getProductByArtesanoId: typeof getProductByArtesanoId;
}
